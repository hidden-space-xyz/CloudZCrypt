...
/// </summary>
public class EncryptionAccessDeniedException(string filePath, Exception innerException) : EncryptionException($"Access denied to file: {filePath}", innerException)
{
}
...
/// </summary>
public class EncryptionFileNotFoundException(string filePath) : EncryptionException($"File not found: {filePath}")
{
}
...
/// </summary>
public class EncryptionInsufficientSpaceException(string path) : EncryptionException($"Insufficient disk space at: {path}")
{
}
...
/// </summary>
public class EncryptionCorruptedFileException(string filePath) : EncryptionException($"The encrypted file appears to be corrupted or invalid: {filePath}")
{
}
...
/// </summary>
public class EncryptionKeyDerivationException(Exception innerException) : EncryptionException("Failed to derive encryption key from password", innerException)
{
}
...
/// </summary>
public class EncryptionCipherException(string operation, Exception innerException) : EncryptionException($"Cipher operation failed during {operation}", innerException)
{
}