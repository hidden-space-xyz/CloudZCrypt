...
public interface IFileOperationsService
{
    ...
    /// </summary>
    /// <param name="directoryPath">The absolute or relative path of the directory to enumerate. Must not be null or empty.</param>
    /// <param name="searchPattern">An optional search pattern (e.g. "*.txt"). Defaults to *.* meaning all files.</param>
    ...
    /// </summary>
    /// <param name="directoryPath">The path to the directory to check. Must not be null or empty.</param>
    ...
    /// </summary>
    /// <param name="filePath">The full or relative path to the file. Must not be null or empty.</param>
    ...
    /// </summary>
    /// <param name="directoryPath">The path of the directory to create. Must not be null or empty.</param>
    /// <param name="cancellationToken">A token that can be used to cancel the asynchronous operation.</param>
    ...
    /// </summary>
    /// <param name="basePath">The starting directory path. Must not be null or empty.</param>
    /// <param name="fullPath">The destination absolute path. Must not be null or empty.</param>
    ...
    /// </summary>
    /// <param name="paths">An ordered collection of path segments. Must not be null and must contain at least one element.</param>
    ...
    /// </summary>
    /// <param name="filePath">The full or relative path to a file or directory. Must not be null or empty.</param>
    /// <returns>The directory name, or null if the path denotes a root directory or cannot be resolved.</returns>
    /// <exception cref="ArgumentNullException">Thrown when <paramref name="filePath"/> is null or empty.</exception>
